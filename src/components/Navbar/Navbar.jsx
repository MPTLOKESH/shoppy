...
const Navbar = () => {
  const Menu = [
    ...
    { id: 4, name: "Mens Wear", link: "/contact" },
    { id: 5, name: "Electronics", link: "/blog" },
  ];

  const DropdownLinks = [
    { id: 2, name: "Trending Products", link: "/#" },
      ...
      <div className="flex justify-center">
        <ul className="sm:flex hidden items-center gap-4">
          ...
          <li className="group relative cursor-pointer">
            <a
              href="#"
              className="flex items-center gap-[2px] py-2 transition all duration-200"
            >
              Trending Products
              <span>
            ...
            <div className=" absolute z-[9999] hidden group-hover:block w-[150px] rounded-md bg-white text-black shadow-sm">
              <ul>
